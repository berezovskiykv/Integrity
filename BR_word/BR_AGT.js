...
#INCLUDE "BR_word/BR_AGT_popup.js"
#INCLUDE "Managers/hover.js"

#ONCE_EXECUTION_BEGIN
    publisher = new Publisher();
    popup = new AGT_popup(publisher, { rootPath : getAliasesPathFromDiagram(), codes : diagram.stringPropValue("codes") });
    //diagram.setDiagramSize(500, 514);
    //diagram.setSize(500, 514);
    showBack(back, "back")
    diagNameMouse = 'br_agt';
