...
#INCLUDE "BO/BO_AP_ParamAlg.js"
#INCLUDE "Managers/hover.js"

#ONCE_EXECUTION_BEGIN
    publisher = new Publisher();
    popup = new AnalogBOPopupAlg(publisher, { rootPath : getAliasesPathFromDiagram(), cmd_on : diagram.stringPropValue("cmd_on"), cmd_off : diagram.stringPropValue("cmd_off"), type : diagram.stringPropValue("type")});
